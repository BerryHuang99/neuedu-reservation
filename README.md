...
This project is an online course reservation platform based on mobile terminals for NEUSOFT. And it's powered by react as well as based on [ant-design-mobile](https://mobile.ant.design/index-cn) and [Axios](https://www.npmjs.com/package/axios).
